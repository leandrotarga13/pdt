							...
							if ( $settings['thumb_single'] == 'true' && ! woo_embed( '' ) ) {
								if ( has_post_format( 'gallery' ) ) { ?>
									<div class="featured-image">
										<?php woo_image( 'width=800&noheight=true&class=thumbnail' ); ?>
									</div>
								<?php } else {
									woo_image( 'width=' . $settings['single_w'] . '&height=' . $settings['single_h'] . '&noheight=true&class=thumbnail ' . $settings['thumb_single_align'] );
								}
							}
